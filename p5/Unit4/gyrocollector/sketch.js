...
function setup() {
  ...
  img1 = loadImage("assets/child.png");
  img2 = loadImage("assets/mando.jpg");
  img3 = loadImage("assets/frog.png");
  imageMode(CENTER);
  rectMode(CENTER);
  noStroke();
}
...
function draw() {
  ...
  textSize(40);
  textAlign(CENTER);
  text("EVERYBODY'S MOVIN!", width / 2, 600, windowWidth - 200, windowHeight - 200);
...
function Car() {
  ...
  this.display = function() {
    ...
    image(img3, this.pos.x, this.pos.y, 150, 100);
  }
